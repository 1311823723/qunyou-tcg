...
const modules = [...comboCharacterSkills, ...aggroCharacterSkills, ...mizaiCharacterSkills, ...bloodCharacterSkills, ...defenseCharacterSkills, ...ambushCharacterSkills] satisfies CharacterSkillModule[];
