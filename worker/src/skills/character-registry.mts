...
const modules = [...comboCharacterSkills, ...aggroCharacterSkills, ...mizaiCharacterSkills, ...bloodCharacterSkills, ...defenseCharacterSkills] satisfies CharacterSkillModule[];
