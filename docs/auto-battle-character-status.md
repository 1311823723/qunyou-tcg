...
| 上头组 | 爆杀流 | 16/16 | 已解锁 |
| 幽幕组 | 伏击流 | 16/16 | 已解锁 |
| 破魔组 | 反制流 | 16/16 | 经典可用，自动待本体 |
| 逆命组 | 卖血流 | 16/16 | 已解锁 |
| 操作组 | 行动流 | 16/16 | 已解锁 |
| 交叉组 | 交叉流 | 16/16 | 经典可用，自动待本体 |
| 不落组 | 防御流 | 16/16 | 已解锁 |
| 执棋组 | 调度流 | 16/16 | 已解锁 |
| 连携组 | 连携流 | 16/16 | 已解锁 |
| 密裁组 | 密裁 | 16/16 | 已解锁 |
...
`char_001_keke_assassin` 刺客-柯柯、`char_003_qindi_sheriff` 警长-秦帝、`char_004_horus-lupercal_pelican` 鹈鹕-荷鲁斯-卢佩卡尔、`char_005_aichitun_jester` 小丑-爱吃豚侠、`char_009_weixiaokele_hitman` 专业杀手-微笑尅乐、`char_010_weixiaokele_bomber` 爆炸王-微笑尅乐、`char_011_baizi_bomber` 爆炸王-摆子、`char_013_weixiaokele_morphling` 变形鸭-微笑尅乐、`char_017_huihuan_defect-robot` 故障机器人-灰焕、`char_018_baizi_defect-robot` 故障机器人-摆子、`char_019_dong_defect-robot` 故障机器人-dong、`char_021_xiaoapan_warlock` 术士-小阿潘、`char_024_weixiaokele_ironclad` 罗莎-微笑尅乐、`char_026_miaosila_neo` 涅奥-喵斯拉、`char_028_arthur_undertaker` 殡葬者-Arthur、`char_029_daidaishou_luna` 露娜-呆呆兽、`char_030_miaosila_detective` 侦探-喵斯拉、`char_031_arthur_watcher` 观者-Arthur、`char_037_keke_seer` 预言家-柯柯、`char_039_keke_judge` 审判官-柯柯、`char_040_fengyaojing_detective` 侦探-风妖精、`char_050_dong_bomber` 爆炸王-dong、`char_053_xiaoka_zaun-beast` 祖安怒兽-小卡、`char_054_xiangcai_prophet` 预言家-香菜、`char_056_huihuan_watcher` 观者-灰焕、`char_060_linglong_defect-robot` 故障机器人-绫珑、`char_062_guamao_morphling` 变形鸭-瓜猫、`char_065_dong_high-priest` 大祭司-dong、`char_070_huihuan_silent-hunter` 静默猎手-灰焕、`char_075_baizi_weilong` 威龙-摆子、`char_076_daidaishou_hackclaw` 骇爪-呆呆兽、`char_077_xiaoapan_shepherd` 牧羊人-小阿潘、`char_078_huihuan_deep-blue` 深蓝-灰焕、`char_079_xiaoka_visionary-painter` 异画师-小卡、`char_080_huihuan_visionary-painter` 异画师-灰焕、`char_099_kabishou_invisible-duck` 隐形鸭-柯柯、`char_100_miaosila_demolitionist` 爆炸王-喵斯拉、`char_102_miaosila_dodo` 呆呆鸟-喵斯拉、`char_103_zongzi_snitch` 告密者-粽子、`char_106_qindi_vulture` 秃鹫-秦帝、`char_113_miaosila_celebrity` 网红-喵斯拉、`char_114_zongzi_bodyguard` 保镖-粽子
...
- 预组角色（去重 120 张）：在下方明细的“预组”列中标明复用关系。
- 非预组角色（0 张）：。
...
| char_002_weixiaokele_assassin | 刺客-微笑尅乐 | 控制 | 上头组、交叉组、执棋组 | 已实现 | 已确认 |  |
...
| char_006_weixiaokele_ninja | 忍者-微笑尅乐 | 伏击 | 上头组、交叉组 | 已实现 | 已确认 |  |
...
| char_015_weixiaokele_lobbyist | 说客-微笑尅乐 | 强攻 | 上头组、破魔组、交叉组、连携组 | 已实现 | 已确认 |  |
| char_016_baizi_gravy | 肉汁-摆子 | 防御 | 上头组、破魔组、交叉组、不落组、变通组 | 已实现 | 已确认 |  |
| char_017_huihuan_defect-robot | 故障机器人-灰焕 | 防御 | 连携组、变通组 | 已实现 | 待实测 | 冰冻充能球的蓄能节奏待实战验证。 |
| char_018_baizi_defect-robot | 故障机器人-摆子 | 强攻 | 变通组 | 已实现 | 待实测 | 黑暗充能球的爆发上限待实战验证。 |
| char_019_dong_defect-robot | 故障机器人-dong | 资源 | 连携组、变通组 | 已实现 | 待实测 | 等离子充能球的降费连锁待实战验证。 |
| char_020_baizi_ironclad | 铁甲战士-摆子 | 强攻 | 破魔组、逆命组、连携组、变通组 | 已实现 | 已确认 |  |
| char_021_xiaoapan_warlock | 术士-小阿潘 | 强攻 | 破魔组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
...
| char_025_baizi_high-priest | 大祭司-摆子 | 防御 | 破魔组、不落组、巡界组 | 已实现 | 已确认 |  |
...
| char_031_arthur_watcher | 观者-Arthur | 控制 | 交叉组、巡界组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
| char_032_weixiaokele_silent-hunter | 黑鸦-微笑尅乐 | 支援 | 破魔组、巡界组、变通组 | 已实现 | 已确认 |  |
| char_033_weixiaokele_watcher | 风姬-微笑尅乐 | 支援 | 破魔组、交叉组、执棋组、变通组 | 已实现 | 已确认 |  |
| char_034_xiaoapan_avenger | 复仇者-小阿潘 | 伏击 | 幽幕组、破魔组 | 已实现 | 已确认 |  |
...
| char_038_keke_avenger | 复仇者-柯柯 | 强攻 | 交叉组、密裁组 | 已实现 | 已确认 |  |
| char_039_keke_judge | 审判官-柯柯 | 控制 | 破魔组、密裁组 | 已实现 | 待实测 | 出牌、响应与濒死三种基础牌需求窗口待实战验证。 |
| char_040_fengyaojing_detective | 侦探-风妖精 | 控制 | 密裁组 | 已实现 | 待实测 | 双方私有选牌与王牌拼点顺序待实战验证。 |
| char_041_baizi_watcher | 观者-摆子 | 资源 | 连携组、密裁组 | 已实现 | 已确认 |  |
| char_042_xiaoapan_neo | 涅奥-小阿潘 | 支援 | 连携组、密裁组 | 已实现 | 已确认 |  |
...
| char_052_fengyaojing_desert-butcher | 荒漠屠夫-风妖精 | 强攻 | 逆命组、交叉组、巡界组 | 已实现 | 已确认 |  |
| char_053_xiaoka_zaun-beast | 祖安怒兽-小卡 | 强攻 | 交叉组、巡界组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
| char_054_xiangcai_prophet | 预言家-香菜 | 资源 | 操作组、交叉组 | 已实现 | 待实测 | 观看5张时的牌堆控制强度待实战验证。 |
| char_055_xiaoapan_judge | 审判官-小阿潘 | 控制 | 执棋组、变通组 | 已实现 | 已确认 |  |
| char_056_huihuan_watcher | 观者-灰焕 | 资源 | 破魔组、操作组、交叉组 | 已实现 | 待实测 | 看3选行动牌的检索效率待实战验证。 |
...
| char_066_linglong_ninja | 忍者-绫珑 | 伏击 | 操作组、执棋组、连携组、变通组 | 已实现 | 已确认 |  |
...
| char_071_xiangcai_lover | 恋人-香菜 | 强攻 | 幽幕组 | 已实现 | 已确认 |  |
...
| char_075_baizi_weilong | 威龙-摆子 | 强攻 | 交叉组、巡界组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
| char_076_daidaishou_hackclaw | 骇爪-呆呆兽 | 控制 | 交叉组、连携组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
| char_077_xiaoapan_shepherd | 牧羊人-小阿潘 | 控制 | 破魔组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
...
| char_080_huihuan_visionary-painter | 异画师-灰焕 | 支援 | 交叉组、巡界组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
...
| char_084_keke_watcher | 观者-柯柯 | 支援 | 执棋组、连携组 | 已实现 | 已确认 |  |
| char_085_aichitun_bodyguard | 保镖-爱吃豚侠 | 防御 | 不落组、执棋组 | 已实现 | 已确认 |  |
| char_086_aichitun_sheriff | 警长-爱吃豚侠 | 强攻 | 执棋组 | 已实现 | 已确认 |  |
| char_087_qindi_vigilante | 正义使者-秦帝 | 强攻 | 幽幕组、逆命组、不落组 | 已实现 | 已确认 |  |
| char_088_horus-lupercal_serial-killer | 连环杀手-荷鲁斯-卢佩卡尔 | 强攻 | 逆命组 | 已实现 | 已确认 |  |
| char_089_kabishou_canadian | 加拿大鹅-柯柯 | 资源 | 幽幕组、破魔组、逆命组 | 已实现 | 已确认 |  |
| char_090_miaosila_medium | 灵媒-喵斯拉 | 资源 | 逆命组、交叉组 | 已实现 | 已确认 |  |
| char_091_zongzi_vulture | 秃鹫-粽子 | 资源 | 逆命组 | 已实现 | 已确认 |  |
| char_092_player_detective | 侦探-机器人 1 号 | 控制 | 逆命组 | 已实现 | 已确认 |  |
| char_093_tutu_snitch | 告密者-图图 | 控制 | 逆命组 | 已实现 | 已确认 |  |
| char_094_daidaishou_astral | 星界使者-呆呆兽 | 支援 | 逆命组 | 已实现 | 已确认 |  |
| char_095_pangpanghali_prophet | 预言家-胖胖哈力 | 支援 | 逆命组 | 已实现 | 已确认 |  |
| char_096_kabishou_politician | 政治家-柯柯 | 支援 | 逆命组 | 已实现 | 已确认 |  |
| char_097_horus-lupercal_bird-eater | 食鸟鸭-荷鲁斯-卢佩卡尔 | 伏击 | 幽幕组 | 已实现 | 已确认 |  |
| char_098_qindi_silencer | 静音-秦帝 | 伏击 | 幽幕组、破魔组 | 已实现 | 已确认 |  |
...
| char_102_miaosila_dodo | 呆呆鸟-喵斯拉 | 伏击 | 破魔组 | 已实现 | 待实测 | 非预组角色已接入全自动结算；自选阵容组合强度待实战验证。 |
...
| char_107_daidaishou_engineer | 工程师-呆呆兽 | 支援 | 幽幕组 | 已实现 | 已确认 |  |
| char_108_tutu_birdwatcher | 观鸟者-图图 | 支援 | 幽幕组、连携组 | 已实现 | 已确认 |  |
| char_109_qindi_bodyguard | 保镖-秦帝 | 防御 | 不落组 | 已实现 | 已确认 |  |
| char_110_pangpanghali_canadian | 加拿大鹅-胖胖哈力 | 防御 | 不落组 | 已实现 | 已确认 |  |
| char_111_horus-lupercal_adventurer | 冒险家-荷鲁斯-卢佩卡尔 | 防御 | 破魔组、交叉组、不落组 | 已实现 | 已确认 |  |
...
| char_116_tutu_vigilante | 正义使者-图图 | 防御 | 破魔组、不落组 | 已实现 | 已确认 |  |
| char_117_daidaishou_medium | 灵媒-呆呆兽 | 防御 | 不落组 | 已实现 | 已确认 |  |
| char_118_qindi_birdwatcher | 观鸟者-秦帝 | 防御 | 不落组 | 已实现 | 已确认 |  |
| char_119_pangpanghali_politician | 政治家-胖胖哈力 | 支援 | 不落组 | 已实现 | 已确认 |  |
| char_120_player_astral | 星界使者-机器人 1 号 | 支援 | 不落组 | 已实现 | 已确认 |  |
