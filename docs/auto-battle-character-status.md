...
| char_015_weixiaokele_lobbyist | 说客-微笑尅乐 | 强攻 | 上头组、破魔组、连携组 | 已实现 | 已确认 |  |
| char_016_baizi_gravy | 肉汁-摆子 | 防御 | 上头组、破魔组、不落组、变通组 | 已实现 | 已确认 |  |
...
| char_033_weixiaokele_watcher | 风姬-微笑尅乐 | 支援 | 破魔组、执棋组、变通组 | 已实现 | 已确认 |  |
...
| char_056_huihuan_watcher | 观者-灰焕 | 资源 | 破魔组、操作组 | 已实现 | 待实测 | 看3选行动牌的检索效率待实战验证。 |
...
| char_090_miaosila_medium | 灵媒-喵斯拉 | 资源 | 逆命组 | 已实现 | 已确认 |  |
...
| char_111_horus-lupercal_adventurer | 冒险家-荷鲁斯-卢佩卡尔 | 防御 | 破魔组、不落组 | 已实现 | 已确认 |  |
