...
| char_015_weixiaokele_lobbyist | 说客-微笑尅乐 | 强攻 | 上头组、连携组 | 已实现 | 已确认 |  |
...
| char_020_baizi_ironclad | 铁甲战士-摆子 | 强攻 | 逆命组、连携组、变通组 | 已实现 | 已确认 |  |
...
| char_089_kabishou_canadian | 加拿大鹅-柯柯 | 资源 | 幽幕组、逆命组 | 已实现 | 已确认 |  |
...
| char_116_tutu_vigilante | 正义使者-图图 | 防御 | 不落组 | 已实现 | 已确认 |  |
